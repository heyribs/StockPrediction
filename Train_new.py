...
for epoch in range(Parameters.epoch):
    ...
    for index in range(batch_num):
        ...
        test_data_former = x_test_former[index*batch_size:(index+1)*batch_size, :, :]
        test_data_latter = x_test_latter[index*batch_size:(index+1)*batch_size, :, :]
        ...
        d.trainable = False
        g_metrics = g_and_d.train_on_batch([noise1, noise2], np.array([1] * batch_size))
